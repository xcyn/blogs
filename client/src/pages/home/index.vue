              ...
              >
                <div class="person-introduce" v-if="!item.isCustom">
                  ...
                  <div class="person-des">
                    <div
                      :key="key"
                      v-for="(des, key) in item.desc"
                      class="des-item"
                    >
                      <div>
                        <div class="des-num">{{ des.subT }}</div>
                        <div class="des-content" v-html="des.message"></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div v-if="item.isCustom">
                  <div class="form-title">
                    <div>给我留言</div>
                    <div class="message-history" @click="handleMHistory">
                      留言记录({{ messageNum }})
                    </div>
                  </div>
                  <cube-form
...
.homeNavs /deep/ .cube-sticky-fixed {
